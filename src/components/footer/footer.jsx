        ...
        <div className='row'>
          ...
          <div className='col-md-8 col-12'>
            <div className='footer__menus'>
              <div>
                <h5 className='menu__title'>Features</h5>
                <ul className='footer__menu'>
                  <li>
                    <a href='https://google.co.uk'>Link Shortening</a>
                  </li>
                  <li>
                    <a href='https://google.co.uk'>Branded Links</a>
                  </li>
                  <li>
                    <a href='https://google.co.uk'>Analytics</a>
                  </li>
                </ul>
              </div>
              <div>
                <h5 className='menu__title'>Resources</h5>
                <ul className='footer__menu'>
                  <li>
                    <a href='https://google.co.uk'>Blog</a>
                  </li>
                  <li>
                    <a href='https://google.co.uk'>Developers</a>
                  </li>
                  <li>
                    <a href='https://google.co.uk'>Support</a>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className='footer__menu'>
                  ...
                  <li>
                    <a href='https://google.co.uk'>Our Team</a>
                  </li>
                  <li>
                    <a href='https://google.co.uk'>Careers</a>
                  </li>
                  <li>
